...
describe('Book CRUD tests', function () {
                  ...
                  .end(function (err, res) {
                    ...
                    agent.get('/api/books/' + bookSaveRes.body._id)
                      ...
                      .end(function (bookInfoErr, bookInfoRes) {
                        ...
                        (bookInfoRes.body.title).should.equal(book.title);
  ...
  it('should be able to get a single book if signed in and verify the custom "isCurrentUserOwner" field is set to "true"', function (done) {
    // Create new book model instance
    book.user = user;
    var bookObj = new Book(book);
            ...
            .end(function (bookSaveErr, bookSaveRes) {
              ...
              agent.get('/api/books/' + bookSaveRes.body._id)
                ...
                .end(function (bookInfoErr, bookInfoRes) {
                  ...
                  (bookInfoRes.body.isCurrentUserOwner).should.equal(true);
  ...
  it('should be able to get a single book if not signed in and verify the custom "isCurrentUserOwner" field is set to "false"', function (done) {
    // Create new book model instance
    var bookObj = new Book(book);
  ...
  it('should be able to get single book, that a different user created, if logged in & verify the "isCurrentUserOwner" field is set to "false"', function (done) {
    ...
    _user.save(function (err, _user) {
      ...
      // Sign in with the user that will create the Book
      agent.post('/api/auth/signin')
        .send(credentials)
        .expect(200)
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/books')
            ...
            .end(function (bookSaveErr, bookSaveRes) {
              ...
              (bookSaveRes.body.title).should.equal(book.title);
              should.exist(bookSaveRes.body.user);
              should.equal(bookSaveRes.body.user._id, userId);
                ...
                .end(function (err, res) {
                  ...
                  agent.get('/api/books/' + bookSaveRes.body._id)
                    ...
                    .end(function (bookInfoErr, bookInfoRes) {
                      ...
                      (bookInfoRes.body.isCurrentUserOwner).should.equal(false);
